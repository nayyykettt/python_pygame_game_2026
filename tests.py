...
from settings import (
    ...
    OBSTACLE_SIZE, HEAL_SIZE, ZONE_WIDTH, ZONE_HEIGHT,
    WIDTH, HEIGHT,
    ...
    DEF_DIF,
    INSTANT_DEATH_IDX,
    MIN_YELLOW_GOLD, MIN_CHAR_DAMAGE,
    TEST_OBJ_SIZE, TEST_MOVE_SPEED, TEST_MOVE_SPEED_SMALL,
    TEST_ZERO_SPEED, TEST_PLAYER_POS_X, TEST_PLAYER_POS_Y, 
    TEST_GRAVITY_FRAMES, TEST_LARGE_DISTANCE,  TEST_HP_OFFSET,
    TEST_GOLD_AMOUNT,
    TEST_DAMAGE_BASE, TEST_DAMAGE_MINUS,
    TEST_RECT_EDGE, TEST_BUTTON_ACTION,
    TEST_BUTTON_TEXT, TEST_BUTTON_TEXT_DEFAULT, TEST_ZONE_TYPE_YELLOW, TEST_ZONE_TYPE_BLUE,
    TEST_ACTION_DIFF_MINUS, TEST_ACTION_Y_GOLD_MINUS,
    TEST_ACTION_C_DMG_MINUS,
