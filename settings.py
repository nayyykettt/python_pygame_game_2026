...
WORDS_BANK = [
    ["вода", "небо", "луна", "стол", "стул", "рука", "нога", "глаз", "день", "ночь",
     "лес", "дом", "мир", "снег", "дождь", "ветер", "огонь", "земля", "море", "путь",
     "хлеб", "мясо", "рыба", "соль", "медь", "тень", "свет", "звук", "пыль", "дым"],
    ["книга", "дверь", "дождь", "город", "рынок", "ведро", "птица", "актер", "океан", "трава",
     "школа", "класс", "парк", "мост", "река", "гора", "поле", "сад", "башня", "окно",
     "полка", "шкаф", "диван", "ковер", "лампа", "часы", "ключ", "замок", "стена", "крыша"],
    ["солнце", "дерево", "дорога", "яблоко", "золото", "корова", "собака", "молоко", "ворона", "работа",
     "машина", "поезд", "автобус", "трамвай", "велосипед", "метро", "такси", "самолет", "корабль", "лодка",
     "утро", "вечер", "зима", "лето", "весна", "осень", "месяц", "год", "неделя", "час"],
    ["планета", "человек", "корабль", "телефон", "самолет", "капуста", "свобода", "красота", "природа", "картина",
     "библиотека", "университет", "больница", "магазин", "ресторан", "кинотеатр", "музей", "театр", "стадион", "вокзал",
     "компьютер", "интернет", "программа", "система", "технология", "наука", "искусство", "литература", "музыка", "кино"]
]
